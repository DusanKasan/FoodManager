...
(function($) {
  ...
  EditableSelect.prototype = {
    ...
    setWidths: function() {
	  ...
	  var padding_left = parseInt(this.text.css('padding-left').replace(/px/, ''), 10);
	  
      //this.text.width(width - padding_right - padding_left);
      this.wrapper.width(width);
      if(this.bg_iframe) {
        this.bg_iframe.width(width);
      };
    },
    createBackgroundIframe: function() {
      ...
      bg_iframe.width(this.select.width());
